...
namespace litehtml
{
	...
	public:
		...
		web_gradient			get_gradient_property(string_id name, bool inherited, litehtml::web_gradient default_value, uint_ptr css_properties_member_offset) const override;
