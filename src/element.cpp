...
web_gradient		element::get_gradient_property		(string_id /*name*/, bool /*inherited*/, web_gradient /*defval*/, uint_ptr /*css_properties_member_offset*/) const LITEHTML_RETURN_FUNC(web_gradient())
